...
4. Add GitHub secrets as needed (see below). For on-chain actions, use the [Bankr skill](https://github.com/BankrBot/skills) in your agent runtime.
...
| `azzle/` | `@azzle/agents` SDK, `base-8453.json`, `list-open.mjs` |
...
| `AZZLE_SUBGRAPH_URL` | Override subgraph (default: Studio v0.1) |
